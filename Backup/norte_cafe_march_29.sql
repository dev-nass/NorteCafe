...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 30, 2025 at 04:04 PM
...
INSERT INTO `add_ons` (`add_on_id`, `name`, `price`, `stocks`, `available`) VALUES
...
INSERT INTO `menu_items` (`menu_item_id`, `name`, `description`, `available`, `category`, `image_dir`) VALUES
(1, 'Americano', 'Bold espresso with hot water for strong coffee lovers.', 1, 'ESPRESSO', '../../storage/backend/img/menu/espresso/americano.png'),
(2, 'Biscoff Latte', 'Espresso with creamy Biscoff spread and cookie flavors.', 1, 'ESPRESSO', '../../storage/backend/img/menu/espresso/biscoff-latte.png'),
(3, 'Cafe Latte', 'Smooth espresso with steamed milk, perfect morning drink.', 1, 'ESPRESSO', '../../storage/backend/img/menu/espresso/cafe-latte.png'),
(4, 'Salted Caramel Latte', 'Espresso and caramel blend with a salty twist.', 1, 'ESPRESSO', '../../storage/backend/img/menu/espresso/salted-caramel-latte.png'),
(5, 'Spanish Latte', 'Sweetened espresso with milk for a rich flavor.', 1, 'ESPRESSO', '../../storage/backend/img/menu/espresso/spanish-latte.png'),
(6, 'Tiramisu Latte', 'Coffee infused with cocoa and mascarpone cheese flavor.', 1, 'ESPRESSO', '../../storage/backend/img/menu/espresso/tiramisu-latte.png'),
(7, 'Cappuccino', 'Espresso, steamed milk, and frothy foam on top.', 1, 'COFFEE', '../../storage/backend/img/menu/coffee/cappuccino.png'),
(8, 'Caramel Macchiato', 'Espresso, milk, and caramel drizzle for sweetness.', 1, 'COFFEE', '../../storage/backend/img/menu/coffee/caramel-macchiato.png'),
(9, 'Kape Tuerca', 'Nutty and bold Filipino coffee blend, aromatic taste.', 1, 'COFFEE', '../../storage/backend/img/menu/coffee/kape-tuerca.png'),
(10, 'Mocha', 'Chocolate and espresso mix for a delightful drink.', 1, 'COFFEE', '../../storage/backend/img/menu/coffee/mocha.png'),
(11, 'White Coffee', 'Mild coffee with creamy milk, smooth and delicious.', 1, 'COFFEE', '../../storage/backend/img/menu/coffee/white-coffee.png'),
(12, 'Cookies & Cream', 'Milk tea blended with chocolate cookie crumbles.', 1, 'MILKTEA', '../../storage/backend/img/menu/milktea/cookies-and-cream.png'),
(13, 'Dark Chocolate', 'Deep and indulgent dark chocolate milk tea.', 1, 'MILKTEA', '../../storage/backend/img/menu/milktea/dark-chocolate.png'),
(14, 'Okinawa', 'Brown sugar-infused milk tea with roasted notes.', 1, 'MILKTEA', '../../storage/backend/img/menu/milktea/okinawa.png'),
(15, 'Red Velvet', 'Rich red velvet tea with sweet creamy topping.', 1, 'MILKTEA', '../../storage/backend/img/menu/milktea/red-velvet.png'),
(16, 'Cappuccino Frappe', 'Frosty cappuccino blended for a refreshing treat.', 1, 'COFFEE FRAPPE', '../../storage/backend/img/menu/coffee-frappe/cappuccino.png'),
(17, 'Caramel Macchiato Frappe', 'Cold caramel coffee blended with ice and milk.', 1, 'COFFEE FRAPPE', '../../storage/backend/img/menu/coffee-frappe/caramel-macchiato.png'),
(18, 'Mocha Frappe', 'Chilled mocha coffee with a chocolatey taste.', 1, 'COFFEE FRAPPE', '../../storage/backend/img/menu/coffee-frappe/mocha.png'),
(19, 'White Coffee Frappe', 'Cold white coffee blend with smooth texture.', 1, 'COFFEE FRAPPE', '../../storage/backend/img/menu/coffee-frappe/white-coffee.png'),
(20, 'Biscoff Cream', 'Smooth Biscoff-flavored drink with a creamy texture.', 1, 'SIGNATURE DRINK', '../../storage/backend/img/menu/signature-drink/biscoff-cream.png'),
(21, 'Matcha Oreo', 'Matcha tea blended with Oreo cookies for crunch.', 1, 'SIGNATURE DRINK', '../../storage/backend/img/menu/signature-drink/matcha-oreo.png'),
(22, 'Matcha Strawberry Foam', 'Matcha with strawberry foam, a refreshing combination.', 1, 'SIGNATURE DRINK', '../../storage/backend/img/menu/signature-drink/matcha-strawberry-foam.png'),
(23, 'Strawberry Whipped Cheese', 'Sweet strawberry drink topped with whipped cheese.', 1, 'SIGNATURE DRINK', '../../storage/backend/img/menu/signature-drink/strawbery-whipped-cheese.png'),
(24, 'Ube Cream', 'Creamy and earthy ube-flavored signature beverage.', 1, 'SIGNATURE DRINK', '../../storage/backend/img/menu/signature-drink/ube-cream.png'),
(25, 'Green Apple Juice', 'Crisp and tangy green apple fruit juice.', 1, 'FRUIT DRINK', '../../storage/backend/img/menu/fruit-drink/green-apple.png'),
(26, 'Lychee Juice', 'Delicate and fragrant lychee fruit juice.', 1, 'FRUIT DRINK', '../../storage/backend/img/menu/fruit-drink/lychee.png'),
(27, 'Mango Juice', 'Smooth and tropical mango fruit juice delight.', 1, 'FRUIT DRINK', '../../storage/backend/img/menu/fruit-drink/mango.png'),
(28, 'Strawberry Juice', 'Fresh strawberry fruit juice, naturally sweet.', 1, 'FRUIT DRINK', '../../storage/backend/img/menu/fruit-drink/strawberry.png'),
(29, 'Green Apple Frappe', 'Green apple fruit blended with ice, refreshing.', 1, 'FRUIT FRAPPE', '../../storage/backend/img/menu/fruit-frappe/green-apple-frappe.png'),
(30, 'Lychee Frappe', 'Blended lychee fruit frappe, subtly floral.', 1, 'FRUIT FRAPPE', '../../storage/backend/img/menu/fruit-frappe/lychee-frappe.png'),
(31, 'Mango Frappe', 'Chilled mango fruit blended into icy goodness.', 1, 'FRUIT FRAPPE', '../../storage/backend/img/menu/fruit-frappe/mango-frappe.png'),
(32, 'Strawberry Frappe', 'Frosty strawberry fruit drink with natural sweetness.', 1, 'FRUIT FRAPPE', '../../storage/backend/img/menu/fruit-frappe/strawberry-frappe.png'),
(33, 'Cheese Beef Nachos', 'Nachos topped with beef and melted cheese.', 1, 'NACHOS', '../../storage/backend/img/menu/nachos/cheese-beef-nachos.png'),
(34, 'Cheese Nachos', 'Crispy nachos drizzled with creamy cheese sauce.', 1, 'NACHOS', '../../storage/backend/img/menu/nachos/cheese-nachos.png'),
(35, 'Ham & Cheese Pizza', 'Classic ham and cheese on a crispy crust.', 1, 'PIZZA', '../../storage/backend/img/menu/pizza/ham-and-cheese-pizza.png'),
(36, 'Pepperoni Pizza', 'Spicy and savory pepperoni slices on pizza.', 1, 'PIZZA', '../../storage/backend/img/menu/pizza/pepperoni-pizza.png'),
(37, 'Shawarma Pizza', 'Middle Eastern flavors on a cheesy pizza.', 1, 'PIZZA', '../../storage/backend/img/menu/pizza/shawarma-pizza.png'),
(38, 'Cheese Sandwich', 'Toasted bread with melted cheese inside.', 1, 'GRILLED SANDWICH', '../../storage/backend/img/menu/grilled-sandwich/cheese-grilled-sandwich.png'),
(39, 'Ham & Cheese Sandwich', 'Grilled sandwich with ham and cheese filling.', 1, 'GRILLED SANDWICH', '../../storage/backend/img/menu/grilled-sandwich/ham-and-cheese-grilled-sandwich.png'),
(40, 'Nutella Sandwich', 'Sweet toasted bread with Nutella chocolate spread.', 1, 'GRILLED SANDWICH', '../../storage/backend/img/menu/grilled-sandwich/nutella-grilled-sandwich.png'),
(41, 'Biscoff Croffle', 'Crispy croffle topped with Biscoff cookie spread.', 1, 'CROFFLES', '../../storage/backend/img/menu/croffles/biscoff-croffle.png'),
(42, 'Nutella Croffle', 'Sweet croffle topped with Nutella chocolate spread.', 1, 'CROFFLES', '../../storage/backend/img/menu/croffles/nutella-croffles.png'),
(43, 'Oreo Cream Croffle', 'Croffle with Oreo crumbles and creamy topping.', 1, 'CROFFLES', '../../storage/backend/img/menu/croffles/oreo-cream-croffles.png'),
(44, 'Tiramisu Croffle', 'Tiramisu-flavored croffle with cocoa and cream.', 1, 'CROFFLES', '../../storage/backend/img/menu/croffles/tiramisu-croffles.png'),
(45, 'Biscoff Mini Donuts', 'Mini donuts covered with Biscoff spread.', 1, 'MINI DONUT', '../../storage/backend/img/menu/mini-donut/biscoff.png'),
(46, 'Chocolate Mini Donuts', 'Soft chocolate-flavored mini donuts, bite-sized delight.', 1, 'MINI DONUT', '../../storage/backend/img/menu/mini-donut/chocolate.png'),
(47, 'Nutella Mini Donuts', 'Mini donuts dipped in Nutella chocolate goodness.', 1, 'MINI DONUT', '../../storage/backend/img/menu/mini-donut/nutella.png'),
(48, 'Oreo Cream Mini Donuts', 'Mini donuts with Oreo cream topping.', 1, 'MINI DONUT', '../../storage/backend/img/menu/mini-donut/oreocream.png');
...
(1, 1, 1, 40.00, '2025-03-20 12:23:52'),
(2, 2, 2, 80.00, '2025-03-23 08:04:32'),
(3, 2, 3, 50.00, '2025-03-23 08:04:32'),
(4, 7, 4, 40.00, '2025-03-23 08:35:01'),
(6, 9, 6, 79.00, '2025-03-23 09:06:55'),
(7, 10, 6, 79.00, '2025-03-23 09:07:37'),
(8, 11, 9, 79.00, '2025-03-23 09:41:52'),
(9, 11, 10, 40.00, '2025-03-23 09:41:52'),
(10, 11, 11, 65.00, '2025-03-23 09:41:52'),
(11, 11, 13, 69.00, '2025-03-23 09:41:52'),
(12, 11, 14, 65.00, '2025-03-23 09:41:52'),
(13, 11, 15, 65.00, '2025-03-23 09:41:52'),
(14, 12, 22, 120.00, '2025-03-26 12:40:22'),
(15, 12, 23, 89.00, '2025-03-26 12:40:22'),
(16, 13, 24, 50.00, '2025-03-26 13:58:16'),
(17, 14, 25, 40.00, '2025-03-26 14:21:37'),
(18, 15, 26, 89.00, '2025-03-27 14:58:39'),
(19, 16, 27, 89.00, '2025-03-27 14:59:04'),
(20, 17, 28, 65.00, '2025-03-29 07:31:08'),
(21, 17, 29, 70.00, '2025-03-29 07:31:08');
...
INSERT INTO `password_reset_requests` (`id`, `email`, `token_selector`, `token_validate`, `exp_date`) VALUES
(7, 'jonasemperor@gmail.com', 'a79a40afb9a1a702', '$2y$10$g.SmxPXlF6zBKf4gAqpJaOyKsgW/YWghLMkaWhtntzgoxua1jYLtu', '1743344553');
...
CREATE TABLE `transactions` (
  ...
  `payment_proof_dir` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `delivery_proof_dir` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `transactions` (`transaction_id`, `user_id`, `rider_id`, `payment_method`, `amount_due`, `amount_tendered`, `change`, `location`, `status`, `payment_proof_dir`, `delivery_proof_dir`, `created_at`, `confirmed_at`, `delivered_at`) VALUES
(1, 4, NULL, NULL, 90.00, NULL, NULL, NULL, 'pending', NULL, NULL, '2025-03-20 12:23:52', NULL, NULL),
(2, 4, NULL, NULL, 180.00, NULL, NULL, NULL, 'pending', NULL, NULL, '2025-03-23 08:04:32', NULL, NULL),
(3, 4, NULL, NULL, 90.00, NULL, NULL, NULL, 'pending', NULL, NULL, '2025-03-23 08:31:48', NULL, NULL),
(4, 4, NULL, NULL, 90.00, NULL, NULL, NULL, 'pending', NULL, NULL, '2025-03-23 08:33:02', NULL, NULL),
(5, 4, NULL, NULL, 90.00, NULL, NULL, NULL, 'pending', NULL, NULL, '2025-03-23 08:33:04', NULL, NULL),
(6, 4, NULL, NULL, 90.00, NULL, NULL, NULL, 'pending', NULL, NULL, '2025-03-23 08:34:35', NULL, NULL),
(7, 4, NULL, NULL, 90.00, NULL, NULL, NULL, 'pending', NULL, NULL, '2025-03-23 08:35:01', NULL, NULL),
(9, 4, NULL, NULL, 129.00, NULL, NULL, NULL, 'pending', NULL, NULL, '2025-03-23 09:06:55', NULL, NULL),
(10, 4, NULL, NULL, 129.00, NULL, NULL, NULL, 'pending', NULL, NULL, '2025-03-23 09:07:37', NULL, NULL),
(11, 4, NULL, NULL, 433.00, NULL, NULL, NULL, 'pending', NULL, NULL, '2025-03-23 09:41:52', NULL, NULL),
(12, 8, NULL, NULL, 259.00, NULL, NULL, NULL, 'pending', NULL, NULL, '2025-03-26 12:40:22', NULL, NULL),
(13, 8, NULL, NULL, 100.00, NULL, NULL, NULL, 'pending', NULL, NULL, '2025-03-26 13:58:16', NULL, NULL),
(14, 8, NULL, NULL, 90.00, NULL, NULL, NULL, 'pending', NULL, NULL, '2025-03-26 14:21:37', NULL, NULL),
(15, 8, NULL, NULL, 139.00, NULL, NULL, NULL, 'Approved', NULL, NULL, '2025-03-27 14:58:39', NULL, NULL),
(16, 8, NULL, NULL, 139.00, NULL, NULL, NULL, 'Approved', NULL, NULL, '2025-03-27 14:59:04', NULL, NULL),
(17, 9, NULL, NULL, 185.00, NULL, NULL, NULL, 'Approved', NULL, NULL, '2025-03-29 07:31:07', '2025-03-29 07:41:33', NULL);
...
INSERT INTO `users` (`user_id`, `first_name`, `last_name`, `username`, `email`, `password`, `contact_number`, `age`, `address`, `role`, `available`, `profile_dir`, `created_at`, `updated_at`) VALUES
(1, NULL, NULL, 'Jonas', 'jonasvincemaca@gmail.com', '$2y$10$F.lpR5v2Kt23QvToHP7CzOXCkCX1cyo/hRuJAMWb46ZkBl2hK4CXy', NULL, NULL, NULL, 'Rider', NULL, NULL, '2025-03-14 12:49:14', NULL),
(2, NULL, NULL, 'Marco', 'marco@gmail.com', '$2y$10$5utcX7iX7.NQCPxzT9NDPeTAS1qulrf0v1Buqdy4QKVqtvGhEr99K', NULL, NULL, NULL, '', NULL, NULL, '2025-03-17 14:20:05', NULL),
(3, NULL, NULL, 'Macawile', 'macawile@gmail.com', '$2y$10$LBdTvW2fV/mub.9gGY1qGejF5PHA2.C1pR5Vp7EoGJGaxvX7uT3Gu', NULL, NULL, NULL, '', NULL, NULL, '2025-03-18 05:22:49', NULL),
(4, NULL, NULL, 'Elisha', 'elisha@gmail.com', '$2y$10$ZOAQFx.mdCMs1xJfQBclJuEpY1miL0GpY0HZR9o4pUL8rJwuzGMDK', NULL, NULL, NULL, '', NULL, NULL, '2025-03-18 14:56:13', NULL),
(7, NULL, NULL, 'Honas', 'jonasemperor@gmail.com', '$2y$10$kEhda1tbaUKdU0I9Ac4ZCe2he6qcmj5ZTmbFhezATrB055/PpQNgm', NULL, NULL, NULL, '', NULL, NULL, '2025-03-21 09:48:52', NULL),
(8, NULL, NULL, 'Susan', 'susan@gmail.com', '$2y$10$r7gNWmwCV8BfEV.CmBEAOumPbPUiPiiG.HZLytd.PBdfNgbRZL/zK', NULL, NULL, NULL, 'Customer', NULL, NULL, '2025-03-26 12:34:39', NULL),
(9, NULL, NULL, 'Honas', 'honas@gmail.com', '$2y$10$P7pD9vP5VYCHkVO9UnrbzOl.Mns4FyxVGMpOuaXrx1JL8O8D5cSFO', NULL, NULL, NULL, 'Customer', NULL, NULL, '2025-03-29 07:10:41', NULL),
(10, NULL, NULL, 'Poke', 'poke@gmail.com', 'rawr123', NULL, NULL, NULL, 'Customer', NULL, NULL, '2025-03-29 15:53:44', NULL),
(11, NULL, NULL, 'Poke', 'poke@gmail.com', 'rawr123', NULL, NULL, NULL, 'Customer', NULL, NULL, '2025-03-29 15:54:22', NULL),
(12, NULL, NULL, 'Poke', 'poke@gmail.com', 'rawr123', NULL, NULL, NULL, 'Customer', NULL, NULL, '2025-03-29 15:54:39', NULL),
(13, NULL, NULL, 'jennifer', 'jen@gmail.com', '$2y$10$0aPXGxjj/o67xJh7/2jOveeUynDNTm9eM8rq8/.ADGkuij.O7Xi.C', NULL, NULL, NULL, 'Admin', NULL, NULL, '2025-03-30 12:52:17', NULL);
...
--
ALTER TABLE `add_ons`
  MODIFY `add_on_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `menu_items`
  MODIFY `menu_item_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT for table `menu_item_sizes`
--
ALTER TABLE `menu_item_sizes`
  MODIFY `menu_item_size_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;
...
ALTER TABLE `carts`
  ...
  ADD CONSTRAINT `carts_ibfk_2` FOREIGN KEY (`menu_item_id`) REFERENCES `menu_items` (`menu_item_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `carts_ibfk_3` FOREIGN KEY (`menu_item_size_id`) REFERENCES `menu_item_sizes` (`menu_item_size_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `carts_ibfk_4` FOREIGN KEY (`add_ons_id`) REFERENCES `add_ons` (`add_on_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Constraints for table `menu_item_sizes`
--
ALTER TABLE `menu_item_sizes`
  ADD CONSTRAINT `menu_item_sizes_ibfk_1` FOREIGN KEY (`menu_item_id`) REFERENCES `menu_items` (`menu_item_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
--
ALTER TABLE `transactions`
  ADD CONSTRAINT `transactions_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `transactions_ibfk_2` FOREIGN KEY (`rider_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
