...
VALUES
    ...
    ('₱10 off', 'fixed, 10.00', 10.00, 1000.00),
...
INSERT INTO `add_ons` (`add_on_id`, `name`, `category`, `price`, `available`) VALUES
(1, 'Booba Pearl', 'MILKTEA', 10.00, 1),
(2, 'Nata', 'MILKTEA', 10.00, 1),
(3, 'Whipped Cream', 'MILKTEA', 15.00, 1),
(4, 'Cheese Cake', 'MILKTEA', 20.00, 1),
(5, 'Caramel Drizzle', 'MILKTEA', 10.00, 1),
(6, 'Milk', 'COFFEE', 25.00, 1),
(7, 'Chocolate Syrup', 'MILKTEA', 40.00, 1),
(8, 'Stawberry Syrup', 'MILKTEA', 50.00, 1),
(9, 'Stawberry Syrup x4', 'MILKTEA', 50.00, 1);
...
(1, '₱5 off', 'fixed', 5.00, 500.00, '2025-05-11 08:04:05'),
(2, '₱10 off', 'fixed, 10.00', 10.00, 1000.00, '2025-05-11 08:04:05'),
(3, '5% off', 'percentage', 0.05, 550.00, '2025-05-11 08:04:05'),
(4, '10% off', 'percentage', 0.10, 1050.00, '2025-05-11 08:04:05'),
(5, '₱5 off', 'fixed', 5.00, 500.00, '2025-05-11 08:04:25'),
(6, '₱10 off', 'fixed, 10.00', 10.00, 1000.00, '2025-05-11 08:04:25'),
(7, '5% off', 'percentage', 0.05, 550.00, '2025-05-11 08:04:25'),
(8, '10% off', 'percentage', 0.10, 1050.00, '2025-05-11 08:04:25'),
(9, '100% off', 'percentage', 0.10, 0.00, '2025-05-13 19:44:00');
...
(1, 'Americano', 'Bold espresso with hot water for strong coffee lovers.', 1, 'ESPRESSO', '/uploads/backend/img/menu/espresso/americano.png', 1),
(2, 'Biscoff Latte', 'Espresso with creamy Biscoff spread and cookie flavors.', 1, 'ESPRESSO', '/uploads/backend/img/menu/espresso/biscoff-latte.png', 1),
(3, 'Cafe Latte', 'Smooth espresso with steamed milk, perfect morning drink.', 1, 'ESPRESSO', '/uploads/backend/img/menu/espresso/cafe-latte.png', 1),
(4, 'Salted Caramel Latte', 'Espresso and caramel blend with a salty twist.', 1, 'ESPRESSO', '/uploads/backend/img/menu/espresso/salted-caramel-latte.png', 1),
(5, 'Spanish Latte', 'Sweetened espresso with milk for a rich flavor.', 1, 'ESPRESSO', '/uploads/backend/img/menu/espresso/spanish-latte.png', 1),
(6, 'Tiramisu Latte', 'Coffee infused with cocoa and mascarpone cheese flavor.', 1, 'ESPRESSO', '/uploads/backend/img/menu/espresso/tiramisu-latte.png', 1),
(7, 'Cappuccino', 'Espresso, steamed milk, and frothy foam on top.', 1, 'COFFEE', '/uploads/backend/img/menu/coffee/cappuccino.png', 1),
(8, 'Caramel Macchiato', 'Espresso, milk, and caramel drizzle for sweetness.', 1, 'COFFEE', '/uploads/backend/img/menu/coffee/caramel-macchiato.png', 1),
(9, 'Kape Tuerca', 'Nutty and bold Filipino coffee blend, aromatic taste.', 1, 'COFFEE', '/uploads/backend/img/menu/coffee/kape-tuerca.png', 1),
(10, 'Mocha', 'Chocolate and espresso mix for a delightful drink.', 1, 'COFFEE', '/uploads/backend/img/menu/coffee/mocha.png', 1),
(11, 'White Coffee', 'Mild coffee with creamy milk, smooth and delicious.', 1, 'COFFEE', '/uploads/backend/img/menu/coffee/white-coffee.png', 1),
(12, 'Cookies & Cream', 'Milk tea blended with chocolate cookie crumbles.', 1, 'MILKTEA', '/uploads/backend/img/menu/milktea/cookies-and-cream.png', 1),
(13, 'Dark Chocolate', 'Deep and indulgent dark chocolate milk tea.', 1, 'MILKTEA', '/uploads/backend/img/menu/milktea/dark-chocolate.png', 1),
(14, 'Okinawa', 'Brown sugar-infused milk tea with roasted notes.', 1, 'MILKTEA', '/uploads/backend/img/menu/milktea/okinawa.png', 1),
(15, 'Red Velvet', 'Rich red velvet tea with sweet creamy topping.', 1, 'MILKTEA', '/uploads/backend/img/menu/milktea/red-velvet.png', 1),
(16, 'Cappuccino Frappe', 'Frosty cappuccino blended for a refreshing treat.', 1, 'COFFEE FRAPPE', '/uploads/backend/img/menu/coffee-frappe/cappuccino.png', 1),
(17, 'Caramel Macchiato Frappe', 'Cold caramel coffee blended with ice and milk.', 1, 'COFFEE FRAPPE', '/uploads/backend/img/menu/coffee-frappe/caramel-macchiato.png', 1),
(18, 'Mocha Frappe', 'Chilled mocha coffee with a chocolatey taste.', 1, 'COFFEE FRAPPE', '/uploads/backend/img/menu/coffee-frappe/mocha.png', 1),
(19, 'White Coffee Frappe', 'Cold white coffee blend with smooth texture.', 1, 'COFFEE FRAPPE', '/uploads/backend/img/menu/coffee-frappe/white-coffee.png', 1),
(20, 'Biscoff Cream', 'Smooth Biscoff-flavored drink with a creamy texture.', 1, 'SIGNATURE DRINK', '/uploads/backend/img/menu/signature-drink/biscoff-cream.png', 1),
(21, 'Matcha Oreo', 'Matcha tea blended with Oreo cookies for crunch.', 1, 'SIGNATURE DRINK', '/uploads/backend/img/menu/signature-drink/matcha-oreo.png', 1),
(22, 'Matcha Strawberry Foam', 'Matcha with strawberry foam, a refreshing combination.', 1, 'SIGNATURE DRINK', '/uploads/backend/img/menu/signature-drink/matcha-strawberry-foam.png', 1),
(23, 'Strawberry Whipped Cheese', 'Sweet strawberry drink topped with whipped cheese.', 1, 'SIGNATURE DRINK', '/uploads/backend/img/menu/signature-drink/strawbery-whipped-cheese.png', 1),
(24, 'Ube Cream', 'Creamy and earthy ube-flavored signature beverage.', 1, 'SIGNATURE DRINK', '/uploads/backend/img/menu/signature-drink/ube-cream.png', 1),
(25, 'Green Apple Juice', 'Crisp and tangy green apple fruit juice.', 1, 'FRUIT DRINK', '/uploads/backend/img/menu/fruit-drink/green-apple.png', 1),
(26, 'Lychee Juice', 'Delicate and fragrant lychee fruit juice.', 1, 'FRUIT DRINK', '/uploads/backend/img/menu/fruit-drink/lychee.png', 1),
(27, 'Mango Juice', 'Smooth and tropical mango fruit juice delight.', 1, 'FRUIT DRINK', '/uploads/backend/img/menu/fruit-drink/mango.png', 1),
(28, 'Strawberry Juice', 'Fresh strawberry fruit juice, naturally sweet.', 1, 'FRUIT DRINK', '/uploads/backend/img/menu/fruit-drink/strawberry.png', 1),
(29, 'Green Apple Frappe', 'Green apple fruit blended with ice, refreshing.', 1, 'FRUIT FRAPPE', '/uploads/backend/img/menu/fruit-frappe/green-apple-frappe.png', 1),
(30, 'Lychee Frappe', 'Blended lychee fruit frappe, subtly floral.', 1, 'FRUIT FRAPPE', '/uploads/backend/img/menu/fruit-frappe/lychee-frappe.png', 1),
(31, 'Mango Frappe', 'Chilled mango fruit blended into icy goodness.', 1, 'FRUIT FRAPPE', '/uploads/backend/img/menu/fruit-frappe/mango-frapp.png', 1),
(32, 'Strawberry Frappe', 'Frosty strawberry fruit drink with natural sweetness.', 1, 'FRUIT FRAPPE', '/uploads/backend/img/menu/fruit-frappe/strawberry-frappe.png', 1),
(33, 'Cheese Beef Nachos', 'Nachos topped with beef and melted cheese.', 1, 'NACHOS', '/uploads/backend/img/menu/nachos/cheese-beef-nachos.png', 1),
(34, 'Cheese Nachos', 'Crispy nachos drizzled with creamy cheese sauce.', 1, 'NACHOS', '/uploads/backend/img/menu/nachos/cheese-nachos.png', 1),
(35, 'Ham & Cheese Pizza', 'Classic ham and cheese on a crispy crust.', 1, 'PIZZA', '/uploads/backend/img/menu/pizza/ham-and-cheese-pizza.png', 1),
(36, 'Pepperoni Pizza', 'Spicy and savory pepperoni slices on pizza.', 1, 'PIZZA', '/uploads/backend/img/menu/pizza/pepperoni-pizza.png', 1),
(37, 'Shawarma Pizza', 'Middle Eastern flavors on a cheesy pizza.', 1, 'PIZZA', '/uploads/backend/img/menu/pizza/shawarma-pizza.png', 1),
(38, 'Cheese Sandwich', 'Toasted bread with melted cheese inside.', 1, 'GRILLED SANDWICH', '/uploads/backend/img/menu/grilled-sandwich/cheese-grilled-sandwich.png', 1),
(39, 'Ham & Cheese Sandwich', 'Grilled sandwich with ham and cheese filling.', 1, 'GRILLED SANDWICH', '/uploads/backend/img/menu/grilled-sandwich/ham-and-cheese-grilled-sandwich.png', 1),
(40, 'Nutella Sandwich', 'Sweet toasted bread with Nutella chocolate spread.', 1, 'GRILLED SANDWICH', '/uploads/backend/img/menu/grilled-sandwich/nutella-grilled-sandwich.png', 1),
(41, 'Biscoff Croffle', 'Crispy croffle topped with Biscoff cookie spread.', 1, 'CROFFLES', '/uploads/backend/img/menu/croffles/biscoff-croffle.png', 1),
(42, 'Nutella Croffle', 'Sweet croffle topped with Nutella chocolate spread.', 1, 'CROFFLES', '/uploads/backend/img/menu/croffles/nutella-croffles.png', 1),
(43, 'Oreo Cream Croffle', 'Croffle with Oreo crumbles and creamy topping.', 1, 'CROFFLES', '/uploads/backend/img/menu/croffles/oreo-cream-croffles.png', 1),
(44, 'Tiramisu Croffle', 'Tiramisu-flavored croffle with cocoa and cream.', 1, 'CROFFLES', '/uploads/backend/img/menu/croffles/tiramisu-croffles.png', 1),
(45, 'Biscoff Mini Donuts', 'Mini donuts covered with Biscoff spread.', 1, 'MINI DONUT', '/uploads/backend/img/menu/mini-donut/biscoff.png', 1),
(46, 'Chocolate Mini Donuts', 'Soft chocolate-flavored mini donuts, bite-sized delight.', 1, 'MINI DONUT', '/uploads/backend/img/menu/mini-donut/chocolate.png', 1),
(47, 'Nutella Mini Donuts', 'Mini donuts dipped in Nutella chocolate goodness.', 1, 'MINI DONUT', '/uploads/backend/img/menu/mini-donut/nutella.png', 1),
(48, 'Oreo Cream Mini Donuts', 'Mini donuts with Oreo cream topping.', 1, 'MINI DONUT', '/uploads/backend/img/menu/mini-donut/oreocream.png', 1),
(49, 'Strawberry', 'Truly a pure strawberry flavour', 1, 'MILKTEA', '/uploads/backend/img/menu_testing/strawberry-milk-tea-featured-image-1.jpg', 1),
(50, 'Strawberry Milktea', 'Enjoy the sweet blen of starberry', 1, 'MILKTEA', '/uploads/backend/img/menu_testing/strawberry-milk-tea-featured-image-1.jpg', 1);
...
(1, 1, 1, 330.35, '2025-07-31 09:17:26'),
(2, 2, 2, 431.43, '2015-04-12 14:10:00'),
(3, 3, 3, 401.39, '2019-02-23 04:07:32'),
(4, 4, 4, 816.44, '2015-06-14 16:30:41'),
(5, 5, 5, 524.66, '2018-03-10 19:33:29'),
(6, 6, 6, 506.40, '2025-03-21 00:45:12'),
(7, 7, 7, 779.60, '2017-12-22 03:13:19'),
...
(1, 7, 101, 2, 'COD', 545.26, 604.84, 59.58, NULL, 'Delivered', NULL, NULL, '2025-03-29 22:10:27', NULL, NULL),
(2, 45, 102, 4, 'COD', 582.50, 741.45, 158.95, NULL, 'Delivered', NULL, NULL, '2016-04-04 15:12:52', NULL, NULL),
(3, 46, 103, 2, 'GCASH', 854.58, 889.33, 34.75, NULL, 'Delivered', NULL, NULL, '2017-05-09 19:50:20', NULL, NULL),
(4, 41, 103, 2, 'COD', 831.76, 860.42, 28.66, NULL, 'Delivered', NULL, NULL, '2020-11-03 11:04:40', NULL, NULL),
(5, 24, 101, 1, 'GCASH', 152.23, 333.89, 181.66, NULL, 'Delivered', NULL, NULL, '2020-01-15 21:11:24', NULL, NULL),
(6, 15, 102, 1, 'COD', 678.26, 796.31, 118.05, NULL, 'Delivered', NULL, NULL, '2021-04-09 10:21:20', NULL, NULL),
(7, 14, 102, 3, 'GCASH', 434.31, 445.96, 11.65, NULL, 'Delivered', NULL, NULL, '2022-11-17 11:19:52', NULL, NULL),
(8, 35, 101, 4, 'GCASH', 920.80, 1090.22, 169.42, NULL, 'Delivered', NULL, NULL, '2018-05-21 11:28:06', NULL, NULL),
(9, 31, 103, 2, 'GCASH', 999.55, 1110.77, 111.22, NULL, 'Delivered', NULL, NULL, '2024-04-08 20:29:23', NULL, NULL),
(10, 18, 101, 2, 'COD', 157.41, 261.17, 103.76, NULL, 'Delivered', NULL, NULL, '2024-12-19 18:34:55', NULL, NULL),
(11, 49, 101, 2, 'COD', 246.97, 385.30, 138.33, NULL, 'Delivered', NULL, NULL, '2021-11-03 04:21:32', NULL, NULL),
(12, 17, 101, 2, 'COD', 972.69, 996.08, 23.39, NULL, 'Delivered', NULL, NULL, '2022-03-09 16:41:31', NULL, NULL),
(13, 10, 101, 2, 'COD', 780.05, 908.99, 128.94, NULL, 'Delivered', NULL, NULL, '2018-01-13 16:10:43', NULL, NULL),
(14, 40, 101, 4, 'COD', 664.92, 811.23, 146.31, NULL, 'Delivered', NULL, NULL, '2020-12-17 12:13:36', NULL, NULL),
(15, 31, 102, 3, 'COD', 112.85, 221.58, 108.73, NULL, 'Delivered', NULL, NULL, '2015-12-24 12:56:37', NULL, NULL),
(16, 43, 102, 2, 'GCASH', 623.36, 635.26, 11.90, NULL, 'Delivered', NULL, NULL, '2016-04-15 00:20:50', NULL, NULL),
(17, 30, 101, 3, 'GCASH', 874.54, 936.38, 61.84, NULL, 'Delivered', NULL, NULL, '2016-11-03 22:39:21', NULL, NULL),
(18, 15, 101, 2, 'GCASH', 115.92, 236.90, 120.98, NULL, 'Delivered', NULL, NULL, '2022-06-18 16:38:09', NULL, NULL),
(19, 49, 101, 4, 'GCASH', 713.06, 814.11, 101.05, NULL, 'Delivered', NULL, NULL, '2017-08-02 00:26:22', NULL, NULL),
(20, 6, 101, 1, 'COD', 986.49, 1019.92, 33.43, NULL, 'Delivered', NULL, NULL, '2022-08-25 18:27:06', NULL, NULL),
(21, 28, 103, 2, 'GCASH', 225.24, 390.20, 164.96, NULL, 'Delivered', NULL, NULL, '2023-08-24 16:07:05', NULL, NULL),
(22, 37, 102, 1, 'COD', 950.46, 992.74, 42.28, NULL, 'Delivered', NULL, NULL, '2017-04-17 07:31:59', NULL, NULL),
(23, 26, 103, 3, 'COD', 501.37, 513.01, 11.64, NULL, 'Delivered', NULL, NULL, '2017-07-08 04:12:24', NULL, NULL),
(24, 35, 103, 1, 'GCASH', 434.02, 551.80, 117.78, NULL, 'Delivered', NULL, NULL, '2017-11-09 18:34:06', NULL, NULL),
(25, 28, 102, 3, 'COD', 533.90, 624.79, 90.89, NULL, 'Delivered', NULL, NULL, '2018-12-02 19:38:36', NULL, NULL),
(26, 18, 103, 1, 'COD', 610.61, 634.10, 23.49, NULL, 'Delivered', NULL, NULL, '2020-02-01 18:08:11', NULL, NULL),
(27, 46, 102, 3, 'GCASH', 950.74, 972.23, 21.49, NULL, 'Delivered', NULL, NULL, '2015-02-26 18:04:30', NULL, NULL),
(28, 42, 102, 2, 'GCASH', 703.71, 844.09, 140.38, NULL, 'Delivered', NULL, NULL, '2021-11-07 14:49:10', NULL, NULL),
(29, 13, 103, 1, 'COD', 305.41, 503.93, 198.52, NULL, 'Delivered', NULL, NULL, '2021-06-06 18:50:32', NULL, NULL),
(30, 23, 103, 2, 'COD', 281.09, 407.34, 126.25, NULL, 'Delivered', NULL, NULL, '2019-07-22 14:19:51', NULL, NULL),
(31, 48, 102, 1, 'COD', 647.09, 802.18, 155.09, NULL, 'Delivered', NULL, NULL, '2021-10-08 08:23:15', NULL, NULL),
(32, 30, 101, 3, 'GCASH', 548.32, 703.89, 155.57, NULL, 'Delivered', NULL, NULL, '2022-05-19 23:14:13', NULL, NULL),
(33, 33, 103, 2, 'COD', 474.34, 582.10, 107.76, NULL, 'Delivered', NULL, NULL, '2021-01-24 01:11:35', NULL, NULL),
(34, 47, 101, 4, 'COD', 293.06, 377.63, 84.57, NULL, 'Delivered', NULL, NULL, '2016-04-23 04:47:15', NULL, NULL),
(35, 19, 101, 2, 'GCASH', 927.18, 1113.66, 186.48, NULL, 'Delivered', NULL, NULL, '2017-12-10 15:24:48', NULL, NULL),
(36, 42, 102, 4, 'COD', 398.78, 534.77, 135.99, NULL, 'Delivered', NULL, NULL, '2019-02-27 11:29:05', NULL, NULL),
(37, 29, 102, 1, 'GCASH', 738.86, 843.98, 105.12, NULL, 'Delivered', NULL, NULL, '2016-02-02 02:49:28', NULL, NULL),
(38, 22, 103, 3, 'COD', 709.33, 858.03, 148.70, NULL, 'Delivered', NULL, NULL, '2022-11-15 03:18:24', NULL, NULL),
(39, 17, 101, 3, 'GCASH', 715.25, 857.46, 142.21, NULL, 'Delivered', NULL, NULL, '2019-02-20 16:07:40', NULL, NULL),
(40, 35, 103, 4, 'GCASH', 539.79, 733.78, 193.99, NULL, 'Delivered', NULL, NULL, '2017-05-10 14:42:49', NULL, NULL),
(41, 28, 102, 3, 'GCASH', 358.00, 501.35, 143.35, NULL, 'Delivered', NULL, NULL, '2021-03-05 00:11:00', NULL, NULL),
(42, 8, 101, 2, 'COD', 545.30, 679.55, 134.25, NULL, 'Delivered', NULL, NULL, '2023-06-29 14:49:29', NULL, NULL),
(43, 48, 101, 2, 'COD', 480.62, 595.57, 114.95, NULL, 'Delivered', NULL, NULL, '2022-03-22 15:17:17', NULL, NULL),
(44, 48, 103, 1, 'COD', 889.70, 1025.99, 136.29, NULL, 'Delivered', NULL, NULL, '2019-07-07 00:51:56', NULL, NULL),
(45, 24, 102, 2, 'COD', 312.58, 497.89, 185.31, NULL, 'Delivered', NULL, NULL, '2023-08-03 05:13:27', NULL, NULL),
(46, 18, 101, 3, 'GCASH', 319.86, 339.35, 19.49, NULL, 'Delivered', NULL, NULL, '2025-08-01 13:21:05', NULL, NULL),
(47, 28, 102, 2, 'GCASH', 786.97, 958.34, 171.37, NULL, 'Delivered', NULL, NULL, '2024-10-16 06:05:51', NULL, NULL),
(48, 30, 103, 4, 'GCASH', 726.96, 770.08, 43.12, NULL, 'Delivered', NULL, NULL, '2023-12-15 11:54:13', NULL, NULL),
(49, 49, 102, 2, 'GCASH', 281.41, 300.97, 19.56, NULL, 'Delivered', NULL, NULL, '2022-08-25 05:19:24', NULL, NULL),
(50, 20, 102, 3, 'GCASH', 498.46, 696.13, 197.67, NULL, 'Delivered', NULL, NULL, '2018-10-22 04:29:00', NULL, NULL),
(51, 7, 103, 3, 'GCASH', 286.92, 385.93, 99.01, NULL, 'Delivered', NULL, NULL, '2024-10-31 06:56:16', NULL, NULL),
(52, 41, 102, 4, 'GCASH', 210.07, 233.13, 23.06, NULL, 'Delivered', NULL, NULL, '2021-08-23 00:09:09', NULL, NULL),
(53, 43, 101, 1, 'COD', 800.17, 897.10, 96.93, NULL, 'Delivered', NULL, NULL, '2022-04-09 06:32:40', NULL, NULL),
(54, 2, 102, 1, 'GCASH', 875.82, 945.29, 69.47, NULL, 'Delivered', NULL, NULL, '2022-11-16 10:27:01', NULL, NULL),
(55, 7, 101, 4, 'COD', 788.78, 866.14, 77.36, NULL, 'Delivered', NULL, NULL, '2022-02-27 08:41:10', NULL, NULL),
(56, 43, 103, 4, 'GCASH', 404.10, 525.34, 121.24, NULL, 'Delivered', NULL, NULL, '2021-01-15 06:10:55', NULL, NULL),
(57, 12, 101, 2, 'GCASH', 540.12, 717.92, 177.80, NULL, 'Delivered', NULL, NULL, '2020-08-29 07:06:21', NULL, NULL),
(58, 19, 101, 2, 'COD', 135.63, 326.09, 190.46, NULL, 'Delivered', NULL, NULL, '2017-03-29 07:57:40', NULL, NULL),
(59, 27, 103, 4, 'GCASH', 847.44, 999.95, 152.51, NULL, 'Delivered', NULL, NULL, '2019-09-12 10:16:08', NULL, NULL),
(60, 40, 102, 1, 'GCASH', 301.10, 349.77, 48.67, NULL, 'Delivered', NULL, NULL, '2020-12-02 13:28:43', NULL, NULL),
(61, 46, 101, 1, 'COD', 621.55, 634.03, 12.48, NULL, 'Delivered', NULL, NULL, '2023-08-19 21:58:57', NULL, NULL),
(62, 15, 102, 4, 'GCASH', 574.72, 620.13, 45.41, NULL, 'Delivered', NULL, NULL, '2021-02-16 16:45:58', NULL, NULL),
(63, 30, 103, 4, 'COD', 780.02, 937.67, 157.65, NULL, 'Delivered', NULL, NULL, '2016-05-03 13:30:17', NULL, NULL),
(64, 24, 102, 3, 'GCASH', 405.43, 576.99, 171.56, NULL, 'Delivered', NULL, NULL, '2021-06-25 17:47:37', NULL, NULL),
(65, 23, 102, 4, 'GCASH', 202.14, 284.57, 82.43, NULL, 'Delivered', NULL, NULL, '2017-04-07 16:36:08', NULL, NULL),
(66, 41, 101, 1, 'COD', 303.37, 305.15, 1.78, NULL, 'Delivered', NULL, NULL, '2015-05-06 00:40:22', NULL, NULL),
(67, 22, 102, 3, 'GCASH', 649.77, 790.38, 140.61, NULL, 'Delivered', NULL, NULL, '2022-08-06 23:30:05', NULL, NULL),
(68, 1, 101, 4, 'COD', 344.38, 479.84, 135.46, NULL, 'Delivered', NULL, NULL, '2020-09-27 18:00:02', NULL, NULL),
(69, 22, 103, 3, 'COD', 303.95, 306.10, 2.15, NULL, 'Delivered', NULL, NULL, '2018-10-03 19:26:12', NULL, NULL),
(70, 22, 102, 1, 'GCASH', 831.22, 896.99, 65.77, NULL, 'Delivered', NULL, NULL, '2023-06-28 02:44:47', NULL, NULL),
(71, 35, 102, 2, 'COD', 431.28, 463.37, 32.09, NULL, 'Delivered', NULL, NULL, '2025-07-20 07:26:57', NULL, NULL),
(72, 41, 101, 1, 'COD', 879.15, 1026.13, 146.98, NULL, 'Delivered', NULL, NULL, '2015-03-03 09:55:52', NULL, NULL),
(73, 23, 101, 1, 'GCASH', 390.94, 448.29, 57.35, NULL, 'Delivered', NULL, NULL, '2015-10-18 17:45:34', NULL, NULL),
(74, 50, 101, 3, 'GCASH', 838.12, 907.63, 69.51, NULL, 'Delivered', NULL, NULL, '2016-10-12 13:06:12', NULL, NULL),
(75, 2, 102, 3, 'GCASH', 875.04, 1036.83, 161.79, NULL, 'Delivered', NULL, NULL, '2025-01-29 06:41:58', NULL, NULL),
(76, 43, 102, 1, 'COD', 960.28, 1040.86, 80.58, NULL, 'Delivered', NULL, NULL, '2022-09-23 14:36:56', NULL, NULL),
(77, 3, 102, 3, 'COD', 478.65, 577.41, 98.76, NULL, 'Delivered', NULL, NULL, '2017-10-01 09:44:26', NULL, NULL),
(78, 46, 101, 4, 'COD', 268.25, 290.43, 22.18, NULL, 'Delivered', NULL, NULL, '2019-01-08 12:38:39', NULL, NULL),
(79, 24, 101, 3, 'GCASH', 899.95, 1038.04, 138.09, NULL, 'Delivered', NULL, NULL, '2016-11-01 12:41:54', NULL, NULL),
(80, 42, 101, 3, 'GCASH', 173.61, 323.99, 150.38, NULL, 'Delivered', NULL, NULL, '2016-08-02 12:13:40', NULL, NULL),
(81, 7, 101, 3, 'COD', 569.58, 650.11, 80.53, NULL, 'Delivered', NULL, NULL, '2022-03-01 08:37:28', NULL, NULL),
(82, 13, 103, 4, 'GCASH', 875.42, 959.04, 83.62, NULL, 'Delivered', NULL, NULL, '2016-04-07 20:30:01', NULL, NULL),
(83, 47, 101, 1, 'COD', 670.26, 700.42, 30.16, NULL, 'Delivered', NULL, NULL, '2020-03-29 20:56:58', NULL, NULL),
(84, 14, 102, 2, 'GCASH', 892.73, 976.23, 83.50, NULL, 'Delivered', NULL, NULL, '2015-11-19 06:29:21', NULL, NULL),
(85, 45, 102, 3, 'GCASH', 641.35, 736.29, 94.94, NULL, 'Delivered', NULL, NULL, '2023-11-26 19:49:10', NULL, NULL),
(86, 47, 103, 3, 'COD', 282.11, 411.83, 129.72, NULL, 'Delivered', NULL, NULL, '2018-10-15 08:30:11', NULL, NULL),
(87, 18, 101, 4, 'COD', 656.56, 680.07, 23.51, NULL, 'Delivered', NULL, NULL, '2023-12-03 19:33:12', NULL, NULL),
(88, 31, 103, 3, 'GCASH', 505.60, 608.44, 102.84, NULL, 'Delivered', NULL, NULL, '2018-08-30 23:09:22', NULL, NULL),
(89, 48, 101, 1, 'GCASH', 527.66, 635.89, 108.23, NULL, 'Delivered', NULL, NULL, '2025-05-05 15:10:47', NULL, NULL),
(90, 3, 102, 2, 'COD', 172.22, 315.01, 142.79, NULL, 'Delivered', NULL, NULL, '2025-02-26 00:05:39', NULL, NULL),
(91, 21, 102, 2, 'COD', 377.07, 557.91, 180.84, NULL, 'Delivered', NULL, NULL, '2024-04-30 15:14:27', NULL, NULL),
(92, 8, 103, 3, 'COD', 231.34, 277.45, 46.11, NULL, 'Delivered', NULL, NULL, '2018-01-10 22:13:27', NULL, NULL),
(93, 3, 101, 1, 'COD', 883.56, 1048.32, 164.76, NULL, 'Delivered', NULL, NULL, '2017-01-20 11:01:15', NULL, NULL),
(94, 4, 102, 4, 'COD', 271.56, 410.03, 138.47, NULL, 'Delivered', NULL, NULL, '2019-11-13 19:07:03', NULL, NULL),
(95, 11, 103, 4, 'COD', 471.19, 665.15, 193.96, NULL, 'Delivered', NULL, NULL, '2022-04-11 22:01:27', NULL, NULL),
(96, 44, 101, 1, 'GCASH', 802.97, 817.53, 14.56, NULL, 'Delivered', NULL, NULL, '2023-10-10 14:28:02', NULL, NULL),
(97, 21, 101, 2, 'COD', 391.78, 410.57, 18.79, NULL, 'Delivered', NULL, NULL, '2023-08-12 05:28:40', NULL, NULL),
(98, 16, 102, 3, 'GCASH', 800.92, 972.55, 171.63, NULL, 'Delivered', NULL, NULL, '2025-03-09 17:05:34', NULL, NULL),
(99, 48, 103, 3, 'COD', 413.00, 544.45, 131.45, NULL, 'Delivered', NULL, NULL, '2024-04-21 13:14:49', NULL, NULL),
(100, 15, 102, 3, 'GCASH', 259.00, 424.91, 165.91, NULL, 'Delivered', NULL, NULL, '2024-10-05 19:57:15', NULL, NULL),
(101, 106, 107, NULL, 'GCASH', 300.00, 330.00, 30.00, 'Blk J1 Lot 14, Fatima Rd, San Francisco 2, Dasmariñas, Cavite, 4A, 4114', 'Delivered', '/uploads/backend/img/proof_of_payment/proof-of-payment.png', '/uploads/backend/img/delivery_proof/delivery-proof.jpg', '2025-05-15 13:36:00', '2025-05-15 14:00:29', '2025-05-15 14:02:00'),
(102, 106, NULL, NULL, 'COD', 345.00, NULL, NULL, 'Blk J1 Lot 14, Fatima Rd, San Francisco 2, Dasmariñas, Cavite, 4A, 4114', 'Approved by Employee', NULL, NULL, '2025-05-27 08:04:17', '2025-05-27 10:43:38', NULL),
...
(13, 'Tanya', 'Taylor', 'user13', 'user13@example.com', '$2b$12$tR7PzoPsrFInUl2U.a87ouayrIh.ZSha2Sd.CVoXyNgrj6RQZ6jUC', '8893742555', 'Male', 56, '1969-02-05', 'Employee', '975', 'Gloria Creek', 'Become', 'New Sarahaven', 'Utah', 'Region IV-A', '7349', NULL, 1, NULL, 1, '2015-07-20 09:49:36', NULL),
...
(101, 'Christine', 'Meyers', 'user101', 'user101@example.com', '$2b$12$1BQsc0V339PC18wgyfqy8uMJIwsCG3n09hzNJpcSHcGW3pZEx6', '046.552.9008x0400', 'Male', 32, '1992-12-21', 'Rider', '778', 'Jessica Squares', 'Ball', 'North Robertstad', 'Wyoming', 'Region IV-A', '5277', 0, 1, NULL, 1, '2015-06-20 19:26:06', NULL),
...
(108, 'Jonas', 'Macawile', 'Jonas Vince', 'macawile.jonasvincep.kld@gmail.com', '$2y$10$WC5xa5S15bRhe/VwlsihEeD6kb6C4SuxK/8T.K99O6IcEgYs9zPLK', '09125789911', 'Male', 19, '2005-08-24', 'Customer', 'Blk J1 Lot 14', NULL, 'San Francisco 2', 'Dasmariñas', 'Cavite', '4A', '4114', NULL, 1, '/uploads/backend/img/profiling/15 Cool Braid Hairstyles for Men to Try in 2024 - Fashion Tips Tricks.jfif', 1, '2025-05-27 12:53:22', '2025-05-27 12:58:09');
...
--
ALTER TABLE `orders`
  MODIFY `order_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;
...
--
ALTER TABLE `transactions`
  MODIFY `transaction_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;
