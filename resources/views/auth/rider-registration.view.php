            ...
            <div class="col-12 py-3">
                <div class="card overflow-hidden ">
                    <div class="card-body p-4 form-section-bg">
                        <h1 class="fs-3 text-center mb-5">Rider Registration</h1>
                        <form id="rider-registration" class="row g-3 needs-validation" action="staff-store" method="POST" enctype="multipart/form-data" novalidate>
                            <div class="row">
