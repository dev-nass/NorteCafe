                            ...
                            <div class="row g-0 h-100">
                                ...
                                <div class="col-md-5 text-center info-section-bg text-white p-3">
                                    ...
                                    <div class="mt-3 mb-4 mt-md-4 mb-md-5">
                                        <p>Don't have an account? <a class="text-decoration-underline text-white" href="register.php">Register Now!</a></p>
                                        ...
                                        <form action="#" method="post" novalidate>
                                            ...
                                            <div class="mb-3">
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <a class="fs--1" href="forgot-pass.php">Forgot Password?</a>
                                                </div>
                                                <div class="form-floating">
