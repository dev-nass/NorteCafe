            ...
            <div class="col-lg-4 d-flex flex-column">
                <div class="card mb-3 shadow-sm" style="max-height: 350px; min-height: 350px; overflow-y: auto;">
                    <div class="card-header pb-0 p-3">
                        <div class="row">
                            <div class="col-6 d-flex align-items-center">
                                <h6 class="mb-0">Detailed Address</h6>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-header pb-0 px-3 d-flex justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <form id="status-approve" action="transaction-update-rider" method="POST">
                                <input
                                    class="d-none"
                                    name="transaction-id"
                            ...
                            <form id="status-reject" action="transaction-update-rider" method="POST">
                                <input
                                    class="d-none"
                                    name="transaction-id"
                                    value="<?= $transactions[0]['transaction_id'] ?>">
