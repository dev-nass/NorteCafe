...
<section class="section-container">
    <div class="container py-5">
        <h5 class="hero-header fs-2 ms-lg-3">Previous Transactions</h5>
        <p class="ms-3">(Rejected, Cancelled or Delivered)</p>
        <div class="row gx-5">
            <?php if (! $previousTransactions) : ?>
                        ...
                        <div class="row white-bg p-3">
                            ...
                            <div class="col-6">
                                <div class="ms-auto d-flex flex-column align-items-end justify-content-center h-100">
                                    ...
                                    <a class="btn btn-link text-danger text-gradient px-3 mt-2 mb-0" style="font-size: .9rem;" href="javascript:;"><i class="material-symbols-rounded text-sm me-2" style="font-size: 1.1rem;">delete</i>Delete</a>
