<aside class="sidenav navbar navbar-vertical navbar-expand-xs z-index-3 border-radius-lg fixed-start ms-2  bg-white my-2"
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav z-index-3">
            ...
            <li class="nav-item">
                <a class="nav-link <?= urlIs('customer-archived-table-admin') ? 'active choco-gradient-bg text-light' : 'text-dark' ?>" href="customer-archived-table-admin">
                    <i class="material-symbols-rounded opacity-5">group</i>
                    <span class="nav-link-text ms-1">Customers</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?= urlIs('menu-archive-table-admin') ? 'active choco-gradient-bg text-light' : 'text-dark' ?>" href="menu-archive-table-admin">
                    <i class="material-symbols-rounded opacity-5">shopping_cart</i>
                    <span class="nav-link-text ms-1">Menu Items</span>
                </a>
            </li>
