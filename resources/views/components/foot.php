        ...
        <div class="container pt-5">
            ...
            <div class="row me-0">
                ...
                <div class="col-12 col-md-6 col-lg-3 mt-3">
                    ...
                    <div class="mt-2">
                        <a class="footer-a" href="https://x.com/Akaneechii25"><i class="fa-brands fa-x-twitter"></i> Twitter</a>

                    </div>
                    <div class="mt-2">
                        <a class="footer-a" href="https://www.instagram.com/nortecafe_cb/"><i class="fa-brands fa-instagram"></i> Instagram</a>
                    </div>
                </div>
