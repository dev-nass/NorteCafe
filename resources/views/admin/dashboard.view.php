        ...
        <div class="row">
            <div class="col-6 col-lg-3 mb-3 mb-lg-0">
                <div class="bg-white rounded shadow p-3 d-flex justify-content-between">
                    ...
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#8f6b61">
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-6 mt-4 mb-3 mb-lg-0">
                <div class="bg-white rounded shadow p-3 pb-2">
                    ...
                    <div id="top-sale-row" class="row">
                        <!-- Top sales goes here (Generated by JS) -->
                    </div>
                </div>
            </div>
        </div>
