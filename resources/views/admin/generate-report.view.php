                    ...
                    <div class="bg-white py-4 px-4 shadow-sm rounded">
                        ...
                        <div class="row">
                            <div class="col-6 mb-3">
                                <label for="validationCustom01" class="form-label">Starting Date</label>
                                <input type="date" class="form-control border border-dark px-2" id="validationCustom01" name="starting_date" required>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="date" class="form-control border border-dark px-2" id="validationCustom02" name="end_date" required>
                                <div class="valid-feedback">
                                    Looks good!
                                </div>
                                <div class="invalid-feedback">
