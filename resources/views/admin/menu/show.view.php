            ...
            <div class="col-md-4 mt-4">
                <div class="card h-100 mb-4 shadow-sm">
                    <div class="card-body pt-4 p-3">
                        <ul class="list-group">
                            <img class="h-100" src="<?= $menuItem[0]['image_dir'] ?>" alt="menu_item_img">
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <ul class="row">
                            <?php foreach ($addOns as $addOn) : ?>
                                <?php if ($menuItem[0]['category'] === $addOn['category']) : ?>
                                    <li class="col-2 d-flex justify-content-between px-3 py-2 mb-2 me-3 border-radius-lg rounded-3" style="background-color: #f5f5f5;">
