                        ...
                        <div class="card bg-transparent shadow-xl">
                            <div class="overflow-hidden position-relative border-radius-xl">
                                ...
                                <div class="card-body position-relative z-index-1 p-3">
                                    ...
                                    <h5 class="text-white mt-4 mb-5 pb-2">Transaction ID: <?= $transactions[0]['transaction_id'] ?></h5>
                                    <div class="d-flex">
                                        <div class="d-flex">
                                            <div class="me-4">
                                            ...
                                            <div>
                                                <p class="text-white text-sm opacity-8 mb-0">Placed At</p>
                                                <h6 class="text-white mb-0"><?= $transactions[0]['created_at'] ?></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-6">
                                <div class="card">
                                    ...
                                    <div class="card-body pt-0 p-3 text-center">
                                        <h6 class="text-center mb-0">Amount Tendered</h6>
