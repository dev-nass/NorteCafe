...
document.addEventListener("DOMContentLoaded", () => {
    const orderQueueContainer = document.querySelector('#assign-trans-container');
    async function fetchOrders() {
        try {
            const response = await fetch("fetch-assigned-transaction");
                        ...
                        <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                            <div class="row w-100">
                                ...
                                <div class="col-5 d-flex flex-column align-items-end justify-content-between">
                                    ...
                                    <div>
                                        <a class="mb-2 choco-btn text-dark px-3 mb-0 text-sm" href="assigned-transaction-rider?id=${data.transaction_id}">View Order</a>
                                    </div>
                                </div>
                            </div>
