...
sr.reveal('.hero-right', {origin: 'top'});
// Utility Used
sr.reveal('.top-slide', {origin: 'top'});
sr.reveal('.container-interval-slide', {interval: 100});
sr.reveal('.down-slide', {origin: 'top'});
sr.reveal('.left-slide', {origin: 'left'});
sr.reveal('.right-slide', {origin: 'right'});