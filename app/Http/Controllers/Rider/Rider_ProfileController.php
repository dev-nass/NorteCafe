...
class Rider_ProfileController extends Controller
{
    ...
    public function index() 
    {
        ...
        return $this->view('Rider/profile.view.php', [
            'title' => "Profile | {$currentUser['role']}",
            "user" => $currentUser,
        ]);
    }
    ...
    public function update() 
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($errors) {
                return $this->redirect('profile-rider');
            }
