...
class User extends Model
{
    ...
    */
    public function findUserOr($param)
    {
        ...
        $sql = "SELECT user_id, first_name, last_name, username, email, password, contact_number, gender, age, date_of_birth, role, house_number, street, barangay, city, province, region, postal_code, available, verified, profile_dir, status, created_at FROM $this->table WHERE $conditions";
    ...
    */
    public function findUserAnd($param)
    {
        ...
        $sql = "SELECT user_id, first_name, last_name, username, email, contact_number, gender, age, date_of_birth, role, house_number, street, barangay, city, province, region, postal_code, available, verified, profile_dir, status, created_at FROM $this->table WHERE $conditions";
