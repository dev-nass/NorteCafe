...
class User extends Model
{
    ...
    */
    public function findUserOr($param)
    {
        ...
        $sql = "SELECT user_id, first_name, last_name, username, email, password, contact_number, gender, age, date_of_birth, address, role, house_number, street, barangay, city, provience, region, postal_code, available, verified, profile_dir FROM $this->table WHERE $conditions";
